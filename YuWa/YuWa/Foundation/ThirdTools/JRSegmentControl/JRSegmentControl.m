...
#define DefaultCurrentBtnColor RGBCOLOR(252, 76, 30, 1)
...
//        [btn setTitleColor:RGBCOLOR(252, 76, 30, 1) forState:UIControlStateHighlighted];
//        [btn setTitleColor:[UIColor blueColor] forState:UIControlStateSelected];
    }
    
    // 如果不设置backgroundColor，第一个按钮的文字颜色就会被设置为默认颜色
    [_currentBtn setTitleColor:_selectedColor forState:UIControlStateNormal];
}
...
- (void)selectedEnd
{
    ...
    UIColor *color = self.selectedColor ? self.selectedColor : DefaultCurrentBtnColor;
