...
- (void)viewDidLoad {
    ...
    [self setUpTableView];
    [self initDropMenu];
    //这里要吊接口   这个接口是现在 获取所有数据后面的
    [self firstAllTableDtas];
...
- (void)menu:(JSDropDownMenu *)menu didSelectRowAtIndexPath:(JSIndexPath *)indexPath {
    ...
    if (indexPath.column == 0) {
        ...
        //这里吊接口的
        //第三个选项
        self.Psort = [_data3 objectAtIndex:indexPath.row];
     [self getTableViewDatasWithSection0:self.Pcategory andSection1:self.Pplace andSort:self.Psort];
...
-(void)firstAllTableDtas{
    NSDictionary *menuDic = [_data1 objectAtIndex:_currentData1Index];
    self.Pcategory= [[menuDic objectForKey:@"data"] objectAtIndex:_currentData1SelectedIndex];
    
    NSDictionary *menuDic2 = [_data2 objectAtIndex:_currentData2Index];
    self.Pplace= [[menuDic2 objectForKey:@"data"] objectAtIndex:_currentData2SelectedIndex];
  
     self.Psort = [_data3 objectAtIndex:_currentData3Index];
...
-(void)initData{
    NSArray*subArray1=@[@"美食",@"火锅",@"生日蛋糕",@"甜点饮品",@"自助餐",@"小吃快餐",@"日韩料理",@"西餐",@"聚餐宴请",@"闽菜",@"烧烤烤肉",@"川湘菜",@"香锅烤鱼",@"江浙菜",@"粤菜",@"中式烧烤/烤串",@"咖啡酒吧",@"西北菜",@"东北菜",@"生鲜蔬果",@"京菜鲁菜",@"云贵菜",@"东南亚菜",@"海鲜",@"素食",@"台湾/客家菜",@"创意菜",@"汤/粥/炖菜",@"蒙餐",@"新疆菜",@"其他美食"];
    NSArray*subArray2=@[@"电影",@"热映电影",@"主题电影"];
    NSArray*subArray3=@[@"酒店",@"经济型酒店",@"快捷连锁",@"主题酒店",@"商务酒店",@"公寓",@"豪华酒店",@"客栈",@"青年旅社",@"度假酒店",@"别墅",@"其他酒店"];
    NSArray*subArray4=@[@"周边游",@"温泉",@"景点",@"主题公园",@"儿童乐园",@"水上乐园",@"动植物园",@"海洋馆",@"短途游",@"直通车",@"展览馆",@"游船",@"酒景套餐",@"滑雪",@"高空观景",@"攀登运动",@"真人CS",@"农家乐",@"密室逃脱",@"滑冰",@"骑马",@"漂流",@"单车出租",@"其他游玩"];
    NSArray*subArray5=@[@"休闲娱乐",@"足疗按摩",@"洗浴/汗蒸",@"KTV",@"酒吧",@"桌游/电玩",@"DIY手工",@"密室逃脱",@"点播电影",@"台球",@"真人CS",@"演出赛事",@"主题影院",@"其他娱乐"];
    NSArray*subArray6=@[@"生活服务",@"衣物/皮具洗护",@"家政服务",@"家政洗衣",@"证件照",@"照片冲印",@"搬家",@"宠物服务",@"体检/齿科",@"健康服务",@"体检",@"鲜花",@"配镜",@"充值服务",@"服饰鞋包",@"开锁",@"商场购物卡",@"电器数码",@"摄影写真",@"婚庆",@"其他生活"];
    NSArray*subArray7=@[@"旅游",@"跟团游",@"自由行",@"当地游",@"国内游",@"境外游",@"机票/火车票",@"景点门票"];
    NSArray*subArray8=@[@"宴会",@"一站式婚礼馆",@"酒店宴会厅",@"特色餐饮"];
    NSArray*subArray9=@[@"时尚购",@"本地购物",@"服饰鞋包",@"配镜",@"鲜花",@"数码家电",@"超市/便利店"];
    NSArray*subArray10=@[@"丽人",@"美发",@"美容美体",@"美甲没睫",@"瑜伽舞蹈",@"瘦身纤体",@"韩式定妆",@"祛痘",@"纹身",@"整形"];
    NSArray*subArray11=@[@"运动建身",@"游泳/水上运动",@"健身房/体操房",@"羽毛球",@"台球",@"武术",@"保龄球",@"高尔夫",@"篮球",@"滑冰",@"射箭",@"网球",@"骑马",@"足球",@"乒乓球",@"壁球",@"舞蹈",@"瑜伽",@"综合体育场馆",@"其他运动"];
    NSArray*subArray12=@[@"母婴亲子",@"儿童乐园",@"婴儿游泳",@"儿童摄影",@"孕妇写真",@"母婴护理",@"月子会所",@"幼儿教育",@"亲子购物",@"手工DIY",@"儿童话剧",@"科普场馆",@"采摘/农家乐",@"主题公园",@"更多亲子服务",];
    NSArray*subArray13=@[@"宠物",@"宠物店",@"宠物医院"];
    NSArray*subArray14=@[@"汽车服务",@"洗车",@"汽车美容",@"汽车改装",@"维修保养",@"打蜡",@"镀晶镀膜",@"小保养",@"玻璃贴膜",@"内饰清洁",@"租车",@"汽车陪练",@"4S汽车店",@"汽车用品",@"停车场",@"更多汽车服务"];
    NSArray*subArray15=@[@"摄影写真",@"婚纱摄影",@"亲子摄影",@"个性写真",@"其他摄影"];
    NSArray*subArray16=@[@"结婚",@"婚纱摄影",@"婚纱礼服",@"成衣定制",@"婚庆服务",@"个性写真",@"婚戒首饰",@"婚礼小成品",@"婚车租凭",@"彩妆造型",@"司仪主持",@"婚礼跟拍",@"婚宴",@"旅游婚纱照",@"婚房装修",@"更多婚礼服务"];
    NSArray*subArray17=@[@"购物",@"女装",@"男装",@"内衣", @"鞋靴",@"食品",@"家居日用",@"美妆",@"箱包",@"运动户外",@"配饰手表",@"母婴玩具",@"家纺",@"数码电器",@"家具家装",@"汽车用品",@"本地购物"];
    NSArray*subArray18=@[@"家装",@"装修设计",@"厨房卫浴",@"家用电器",@"家装卖场",@"装修建材"];
    NSArray*subArray19=@[@"学习培训",@"外语培训",@"音乐培训",@"美术培训",@"书法培训",@"驾校",@"教育院校",@"职业技术",@"升学辅导",@"留学",@"兴趣生活",@"更多教育培训"];
    NSArray*subArray20=@[@"医疗",@"医院",@"齿科口腔",@"骨科", @"中医保健",@"体检中心",@"药店"];
    ...
    NSArray*placeArray2=@[@"丰泽区",@"丰泽广场/丰泽街",@"大洋百货周边",@"星光不夜城及周边",@"浦西万达广场",@"泉州客运中心周边",@"永辉/现代家居广场",@"后埔浔埔/丰海路",@"美食街",@"侨乡体育馆/东湖",@"中骏世界城",@"润柏香港城",@"东海湾新华都广场",@"东海大街/宝山/宝珊",@"六灌路",@"领SHOW天地",@"华侨大学周边",@"宝洲路",@"灵山墓/郑成功公园",@"清源山180医院",@"津淮街"];
    NSArray*placeArray3=@[@"鲤城区",@"泉州酒店周边",@"涂门街",@"T淘园",@"凯德广场",@"浮桥",@"西湖公园周边",@"东街/第一医院",@"西街",@"九一路/文化宫",@"南俊路",@"北门街/中山公园"];
    NSArray*placeArray4=@[@"晋江市",@"时代广场",@"池店",@"万达广场",@"SM广场",@"阳光广场",@"泉安中路",@"安海",@"清濛开发区",@"宝龙广场",@"市标",@"东石镇",@"金井镇",@"国际机场",@"晋江市医院",@"五店市",@"英林"];
    NSArray*placeArray5=@[@"石狮市",@"德辉广场",@"泰禾广场",@"灵狮中路",@"步行街",@"龟湖公园",@"星期Yi",@"闽南理工学院",@"金汇花园",@"石城广场",@"世茂摩天城"];
    NSArray*placeArray6=@[@"南安市",@"市区",@"南安水头镇",@"官桥镇",@"梅山镇",@"洪濑镇",@"石井镇",@"霞美镇",@"康美镇"];
    NSArray*placeArray7=@[@"惠安县",@"中新花园",@"大红铺",@"东南大街",@"天山广场",@"大润发",@"东园镇",@"崇武镇",@"惠兴街",@"洛阳镇"];
    NSArray*placeArray8=@[@"洛江区",@"洛江",@"双阳"];
    NSArray*placeArray9=@[@"安溪县",@"宝龙城市广场",@"县政府",@"海峡茗城",@"龙湖",@"北石光德"];
    NSArray*placeArray10=@[@"泉港区",@"新民街",@"山腰",@"植物园",@"生活区",@"金山街",@"万星城市广场",@"中心工业区"];
    NSArray*placeArray11=@[@"永春县",@"万星文化广场",@"环城路"];
    NSArray*placeArray12=@[@"德化县",@"德化中医院",@"德化县医院"];
    NSArray*placeArray13=@[@"金门县"];
